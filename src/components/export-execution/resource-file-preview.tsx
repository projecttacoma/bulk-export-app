...
import { stringifyJsonArray as stringifyJsonObjectArray } from '@/util/ndjsonParsers';
...
export default function ResourceFilePreview({ file }: ResourceFilePreviewProps) {
  ...
  const code = stringifyJsonObjectArray(file.objectArray, activePage - 1);
  ...
  return (
    <>
      ...
      <ScrollArea.Autosize mah={600} mx="auto" scrollbars="y" bd="1px solid gray.2" mr="lg" ml="lg">
        <CodeHighlight withCopyButton={false} code={code} language="json"></CodeHighlight>
      </ScrollArea.Autosize>
      <Center mt="xs">
